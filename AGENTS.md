...
Pull Request 应包含改动摘要、验证命令和关键结果。实验相关 PR 需要注明数据集/场景、encoder、decoder、压缩率、epoch 数、seed、checkpoint 和 NMSE 变化。不要把数据集、日志、TensorBoard 文件、checkpoint 或大体积分析产物加入提交。
